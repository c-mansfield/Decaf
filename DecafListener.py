...
class DecafListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by DecafParser#data_literal.
    def enterData_literal(self, ctx:DecafParser.Data_literalContext):
        pass

    # Exit a parse tree produced by DecafParser#data_literal.
    def exitData_literal(self, ctx:DecafParser.Data_literalContext):
        pass
